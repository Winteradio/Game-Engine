...
layout(std430, binding = 0) buffer uRawTransform
{
    RawTransform rawTransforms[];
};
...
void main()
{
    ...
    RawTransform rawTransform = rawTransforms[uThread];
    transforms[uThread] = GetTransform(rawTransform);
}